$("#crew_filter_form").submit(function () {
	$.ajax({
		url: base_url + "reporting-crew-search",
		type: "POST",
...
$("#BtnResetSearch").click(function () {
	$.ajax({
		url: base_url + "reporting-search-reset",
		type: "POST",
		success: function (data) {
			location.reload(true);
		},
...
function getViewEditApplication(crew_code) {
	getCrewInformationFR(crew_code);
	getApplicantInformationFR(crew_code);
	getNextOfKinFR(crew_code);
	getEducationalAttainmentFR(crew_code);
	getWorkingGearsFR(crew_code);

	$("#v_e_crew_information_modal").modal("show");
}

function getCrewInformationFR(crew_code) {
	$.ajax({
...
function getApplicantInformationFR(crew_code) {
	$.ajax({
...
function getNextOfKinFR(crew_code) {
	$.ajax({
...
function getEducationalAttainmentFR(crew_code) {
	$.ajax({
...
function getWorkingGearsFR(crew_code) {
	$.ajax({
...
function PrintReport(c_type) {
	window.open(base_url + "print-for-reporting" + "/" + c_type);
}
