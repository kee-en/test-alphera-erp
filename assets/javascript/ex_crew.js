$("#crew_filter_form").submit(function (data) {
	$.ajax({
		url: base_url + "excrew-search",
		type: "POST",
		data: $("#crew_filter_form").serialize(),
		success: function (data) {
			window.location.replace(base_url + 'ex-crew');
		},
	});
});
$("#BtnResetSearch").click(function () {
	$.ajax({
		url: base_url + "excrew-search-reset",
		type: "POST",
		success: function (data) {
...
function getViewEditApplicationEx(crew_code) {
	getCrewInformationEx(crew_code);
	getApplicantInformationEx(crew_code);
	getNextOfKinEx(crew_code);
	getEducationalAttainmentEx(crew_code);
	getWorkingGearsEx(crew_code);

	$("#v_e_crew_information_modal").modal("show");
}

function getCrewInformationEx(crew_code) {
	$.ajax({
		...
		success: function (data) {
			...
			$("#e_crew_code").val(crew_code);
		},
	});
}

function getApplicantInformationEx(crew_code) {
	$.ajax({
...
function getNextOfKinEx(crew_code) {
	$.ajax({
...
function getEducationalAttainmentEx(crew_code) {
	$.ajax({
...
function getWorkingGearsEx(crew_code) {
	$.ajax({
...
function showShipboardAppEx(code) {
	shipboardApplicationPersonalInfoEx(code);
	getApplicantsEx(code);
	$("#v_crew_off_signer_modal").modal("show");
}

function getApplicantsEx(crew_code) {
	$.ajax({
		url: base_url + "get-crew-information",
		type: "POST",
		data: {
...
function shipboardApplicationPersonalInfoEx(code) {
	$.ajax({
		url: base_url + "get-applicant-information",
		type: "POST",
		data: {
