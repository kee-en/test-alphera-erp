...
function getViewEditApplicationNre(crew_code) {
	getCrewInformationNre(crew_code);
	getApplicantInformationNre(crew_code);
	getNextOfKinNre(crew_code);
	getEducationalAttainmentNre(crew_code);
	getWorkingGearsNre(crew_code);

	$("#v_e_crew_information_modal").modal("show");
}

function getCrewInformationNre(crew_code) {
	$.ajax({
...
function getApplicantInformationNre(crew_code) {
	$.ajax({
...
function getNextOfKinNre(crew_code) {
	$.ajax({
...
function getEducationalAttainmentNre(crew_code) {
	$.ajax({
...
function getWorkingGearsNre(crew_code) {
	$.ajax({
...
function showShipboardAppNre(code) {
	...
	$.ajax({
		...
		success: function (data) {
			if (data != null) {
				...
				$("#on_tentative_vessel").html(formatVessel(data.assign_vessel));
...
function shipboardApplicationPersonalInfo(code) {
	$.ajax({
		...
		success: function (data) {
			...
			getSeaserviceRecordTotalNre(data.applicant_code);
		},
	});
}
...
function getSeaserviceRecordTotalNre(applicant_code) {
	$.ajax({
...
$("#crew_filter_form").submit(function () {
	$.ajax({
		url: base_url + "nre-crew-search",
		type: "POST",
		data: $("#crew_filter_form").serialize(),
		success: function (data) {
			window.location.replace(base_url + 'nre-crew');
		},
	});
});
...
$("#BtnResetSearch").click(function () {
	$.ajax({
		url: base_url + "reset-nre-crew-search",
		type: "POST",
		success: function (data) {
			location.reload(true);
		},
