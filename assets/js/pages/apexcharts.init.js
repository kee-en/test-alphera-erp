...
(chart = new ApexCharts(document.querySelector("#repatriation-graph-1"), options)).render();
...
//     }
// };
// (chart = new ApexCharts(document.querySelector("#apex-donut-1"), options)).render();
...
//     }
// };
// (chart = new ApexCharts(document.querySelector("#apex-donut-2"), options)).render();
...
//     }
// };
// (chart = new ApexCharts(document.querySelector("#apex-donut-3"), options)).render();
...
(chart = new ApexCharts(document.querySelector("#apex-pie-duplicate"), options)).render();
options = {
    chart: {
        height: 320,
        type: "donut",
