                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Create New Application</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Create New Application</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" id="r_type_crew" name="r_type_crew">
                                                                    <option value="">Choose option</option>
...
<script type="text/javascript" src="<?= base_url('assets/custom/js/custom.min.js') ?>"></script>
<script type="text/javascript" src="<?= base_url("assets/custom/js/create_new_application.min.js") ?>"></script>