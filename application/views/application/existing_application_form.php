<style>
    ...
    .input-card~.card-content .card-state-icon {
        position: absolute;
        top: 5px;
        right: 5px;
        z-index: 2;
    ...
    .input-card~.card-content:before {
        position: absolute;
        top: 1px;
        right: 1px;
        width: 0;
        height: 0;
        border-top: 20px solid #ed6d4b;
        border-left: 20px solid transparent;
        transition: all 200ms ease-out;
    }

    .input-card~.card-content:after {
        position: absolute;
        top: 1px;
        right: 1px;
        content: "";
    ...
    .input-card~.card-content:hover {
        border: 1px solid #ed6d4b;
    }

    .input-card~.card-content:hover .card-state-icon {
        background-position: -30px 0;
    }

    .input-card~.card-content:hover:before {
        border-top: 20px solid #ed6d4b;
    }

    .input-card:checked~.card-content {
        border: 1px solid #ed6d4b;
    }

    .input-card:checked~.card-content .card-state-icon {
        background-position: -90px 2px;
    }

    .input-card:checked~.card-content:before {
        border-top: 20px solid #ed6d4b;
        background: url("https://www.shareicon.net/download/2016/08/20/817721_check.svg") no-repeat;
    }

    .input-card:checked~.card-content:after {
        border-top: 20px solid #ed6d4b;
    }

    .input-card:checked:hover~.card-content .card-state-icon {
        background-position: -60px 2px;
    }

    .input-card:checked:hover~.card-content:before {
        border-top: 20px solid #ed6d4b;
    }

    .input-card:checked:hover~.card-content:after {
        border-top: 20px solid #ed6d4b;
    }
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Add Existing Crew</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Add Existing Crew</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">Shipboard Employment Application (Add Existing Crew)</p>
                            <p class="text-muted m-0">Please fill up the form below to process your application.</p>
                        </div>
                        <div class="card-body">
                            <form action="javascript:void(0)" id="existing_application_form" name="existing_application_form" enctype="application/x-www-form-urlencoded">
                                <input type="hidden" class="form-control" id="applicant_code" name="applicant_code">
                                ...
                                <div id="btnwizard">
                                    ...
                                    <div class="tab-content b-0 mb-0 pt-0">
                                        ...
                                        <div class="tab-pane" id="tab1">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Current Rank / Position <span class="asterisk">*</span></label>
                                                                <select class="custom-select" id="s_current_position" name="s_current_position">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Current Vessel <span class="asterisk">*</span></label>
                                                                <select class="custom-select" id="s_current_vessel" name="s_current_vessel">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Current Crew Status <span class="asterisk">*</span></label>
                                                                <select class="custom-select" id="s_current_crew_status" name="s_current_crew_status">
                                                        ...
                                                        <div class="col-md-4" id="embark_date" style="display: none;">
                                                            <div class="form-group">
                                                                <label>Embark Date <span id="embark_span" class="asterisk" style="display: none;">*</span></label>
                                                                <input type="date" class="form-control" id="s_embark_onsigner_date" name="s_embark_onsigner_date">
                                                            </div>
                                                        </div>

                                                        <div class="col-md-4" id="disembark_date" style="display: none;">
                                                            <div class="form-group">
                                                                <label>Disembark Date <span id="disembark_span" class="asterisk" style="display: none;">*</span></label>
                                                                <input type="date" class="form-control" id="s_disembark_onsigner_date" name="s_disembark_onsigner_date">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" id="s_type_crew" name="s_type_crew">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Suffix</label>
                                                        <input type="text" class="form-control" id="s_suffix" name="s_suffix" placeholder="Suffix" onkeypress="return isAlphabet(event)">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <p class="text-alphera font-18 mt-0 mb-1">II. Licenses / Endorsement / Book / ID</p>
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <p class="text-alphera font-18 mt-0 mb-1">III. Training Certificates</p>
                                                    <p class="text-muted m-0">Fill up the required fields below.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p class="text-alphera font-18 mt-0 mb-1">IV. Sea Service Record</p>
                                                    <p class="text-muted m-0">Fill up the required fields below.</p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="float-right">
                                                        <button type="submit" class="btn btn-success" id="btnSubmitApplication">Submit Your Application</button>
                                                    </div>
                                                    <div class="float-left">
                                                        <button type="button" class="btn btn-secondary button-previous">Previous</button>
                                                    </div>
...
<script type="text/javascript" src="<?= base_url('assets/javascript/existing_crew.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/javascript/existing_crew_submit.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/custom/js/custom.js') ?>"></script>