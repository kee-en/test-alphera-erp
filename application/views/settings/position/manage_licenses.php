                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Manage Licenses</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Manage Licenses</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">Add Licenses Per Position</p>
                            <span class="text-muted">Fill up the required fields below.</span>
                        </div>
                        <div class="card-body">
                            <form action="javascript:void(0)" id="position_licenses_form">
                                <div class="row">
                                    <div class="col md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-alphera" id="btn_save_licenses">Save Changes</button>
                                            </div>
                                        </div>
...
<script type="text/javascript" src="<?= base_url('assets/javascript/manage_licenses.js') ?>"></script>