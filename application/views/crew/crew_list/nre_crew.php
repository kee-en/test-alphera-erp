...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> NRE Crew</li>
                            </ol>
                        </div>
                        <h4 class="page-title">NRE Crew</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">NRE Crew</p>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('csv','nre')">CSV</a>
                                                <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('excel','nre')">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url("print-nre-crews") ?>" target="_blank">PDF</a>
                                                <!-- <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('pdf','nre')">PDF</a> -->
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="view_grid" id="view_grid" style="display: none;">
                                <div class="row">
                                    <?php if (!empty($crew)) : ?>
                                        <?php foreach ($crew as $key) : ?>
                                            <div class="col-md-4 mb-2" id="div_applicant">
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col">
                                                            <button type="button" class="btn btn-alphera btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Shipboard Employment Application" onclick="getViewEditApplicationNre('<?= $key['crew_code'] ?>')"><i class="mdi mdi-pencil"></i></button>
                                                        </div>
                                                ...
                                                <tbody class="text-center">
                                                    <?php if ($crew) : ?>
                                                        ...
                                                        foreach ($crew as $reporting) :
                                                            ...
                                                            $contract_duration = strtotime($reporting['contract_duration']);
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <?= $this->global->getCMP($reporting['monitor_code'])['sign_on'] ? '<td>' . date('M j, Y', strtotime($this->global->getCMP($reporting['monitor_code'])['sign_on'])) . '</td>' : '<td>-</td>' ?>
                                                                <?= $reporting['contract_duration'] ? '<td ' . $class . '>' . date('M j, Y', strtotime($this->global->getCMP($reporting['monitor_code'])['disembark'])) . '</td>' : '<td>-</td>' ?>
                                                                <td>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/nre.js') ?>"></script>