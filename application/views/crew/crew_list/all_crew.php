...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> All Crew</li>
                            </ol>
                        </div>
                        <h4 class="page-title">All Crew</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">All Crew</p>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('csv','all')">CSV</a>
                                                <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('excel','all')">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url("print-all-crews") ?>" target="_blank">PDF</a>
                                                <!-- <a class="dropdown-item" href="javascript: void(0);" onclick="PrintReport('pdf','all')">PDF</a> -->
                                            </div>
                                        </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <?= $this->global->getCrewStatus($key['crew_status']) ?>
                                                        ...
                                                        <div class="col">
                                                            <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a class=" dropdown-item" href="javascript:void(0)" onclick="viewCrewContracts('<?= $key['crew_code'] ?>','<?= strtoupper($key['full_name']) ?>')">View Contracts (POEA / MLC)</a>
                                                                    ...
                                                                    <a class="dropdown-item" href="javascript:void(0)" onclick="getVesselHistory('<?= $key['crew_code'] ?>','<?= strtoupper($key['full_name']) ?>')">View Vessel History</a>
                                                                    <!-- <div role="separator" class="dropdown-divider"></div>
                                                                    <h6 class="dropdown-header"><b>Pre-Joining Routing Slip</b></h6>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#manage_routing_slip_modal">Manage Routing Slip</a> -->
                                                                    <!-- <div role="separator" class="dropdown-divider"></div> -->
                                                                    <?php $check = $this->all_crew->checkRequirements($key['crew_code']);
                                                                    if ($check['type'] === "incomplete") : ?>
                                                                        <?php if ($key['crew_status'] === "3" || $key['crew_status'] === "4") : ?>
                                                                            <div role="separator" class="dropdown-divider"></div>
                                                ...
                                                <tbody class="text-center">
                                                    <?php if ($crew) : ?>
                                                        ...
                                                        foreach ($crew as $key) :
                                                            ...
                                                            $contract_duration = $key['disembark'] ? strtotime($key['disembark']) : strtotime($key['contract_duration']);
                                                            $diff = $contract_duration - $current_date;
                                                            $not_change = $contract_duration - $current_date;

                                                            $date_diff = round($diff / (60 * 60 * 24));
                                                            $excess_5 = round($not_change / (60 * 60 * 24));
                                                            $class = "";
                                                            $class_lagpas = "";
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $key['embark'] != NULL ? date('M j, Y', strtotime($key['embark'])) : "-" ?></td>
                                                                <td <?= $key['disembark'] ? $class : "" ?>><?= $key['disembark'] ? date('M j, Y', strtotime($key['disembark'])) : '-' ?></td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <?= $this->global->getCrewStatusBadge($key['crew_status']) ?>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php else : ?>
    ...
    <script>
        var filter_by = "<?= $this->session->userdata('search_filter') ?>";
    </script>
    <!-- All Crew JavaScript Main -->
    <script type="text/javascript" src="<?= base_url('assets/javascript/all_crew.js') ?>"></script>