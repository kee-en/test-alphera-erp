...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Pre-joining & Visa</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Pre-joining & Visa</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row mb-5">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">Pre-joining & Visa</p>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url("print-prejoining-visa-crews") ?>" target="_blank">PDF</a>
                        ...
                        <div class="card-body">
                            <?php if ($search['name_search'] || $search['rank_search'] || $search['vessel_search'] || $search['contract_search'] || $search['flight_search'] || $search['month_search_from'] || $search['month_search_to']) : ?>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <?php if ($crew) : ?>
                                        <?php foreach ($crew as $key) : ?>
                                            <div class="col-md-4 mb-2" id="div_applicant">
                                                <li class="list-group-item" <?= $this->crew_management->get_license_validity_card($key['crew_code']) ?>>
                                                    <div class="media">
                                                        ...
                                                        <div class="col">
                                                            <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#v_crew_off_signer_modal" onclick="viewOffsignerDetails('<?= $key['crew_code'] ?>')">View Shipboard Application</a>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/prejoining_report.js') ?>"></script>