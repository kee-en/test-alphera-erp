<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Medical Monitoring</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Medical Monitoring</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">Medical Monitoring</p>
                            <span class="text-muted">Fill up the required fields below.</span>
                        </div>
                        <form method="POST" action="print-medical-monitoring" id="prejoining_monitoring_form" enctype="application/x-www-form-urlencoded">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="r_filter_by_type" name="r_filter_by_type">
                                                <option value="3" selected>Medical Monitoring</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Medical Date From <span class="text-alphera">*</span></label>
                                            <input type="date" class="form-control" placeholder="Date From" id="m_date_from" name="m_date_from">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Medical Date To <span class="text-alphera">*</span></label>
                                            <input type="date" class="form-control" placeholder="Date To" id="m_date_to" name="m_date_to">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary" id="btnGenerate" onclick="GenerateMedicalReport();">Generate</button>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover m-0 table-centered table-bordered">
                                            ...
                                            <tbody>
                                            <?php if ($medical_logs): ?>
                                                    <?php foreach ($medical_logs as $row): ?>
                                                        <tr>
                                                            <td><?= $row['id'] ?></td>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/medical_monitoring.js'); ?>"></script>