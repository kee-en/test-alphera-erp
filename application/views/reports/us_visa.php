<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> US Visa Status</li>
                            </ol>
                        </div>
                        <h4 class="page-title">US Visa Status</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">US Visa Status</p>
                            <span class="text-muted">Fill up the required fields below.</span>
                        </div>
                        <form method="POST" action="print-us-visa-report" id="manage_reports_form" enctype="application/x-www-form-urlencoded">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="r_filter_by_type" name="r_filter_by_type">
                                                <option value="3" selected>US Visa Status</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Disembarked Date From <span class="text-alphera">*</span></label>
                                            <input type="date" class="form-control" placeholder="Date From" id="r_date_from" name="r_date_from">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Disembarked Date To <span class="text-alphera">*</span></label>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/us_visa.js'); ?>"></script>