<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">Panama Monitoring Record</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Panama Monitoring Record</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">Panama Monitoring Record</p>
                            <span class="text-muted">Fill up the required fields below.</span>
                        </div>
                        <form method="POST" action="print-panama-monitoring" id="panama_monitor_form"  enctype="application/x-www-form-urlencoded">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="r_filter_by_type" name="r_filter_by_type">
                                                <option value="5" selected>Panama Monitoring Record</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="r_type_of_license" name="r_type_of_license">
                                                <option value="1">Panama & GMDSS License</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover m-0 table-centered table-bordered">
                                            ...
                                            <tbody>
                                            <?php if ($panama_logs): ?>
                                                    <?php foreach ($panama_logs as $row): ?>
                                                        <tr>
                                                            <td><?= $row['id'] ?></td>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/panama_monitoring.js'); ?>"></script>