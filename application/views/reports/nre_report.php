<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> NRE Report</li>
                            </ol>
                        </div>
                        <h4 class="page-title"> NRE Report</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 mt-1">
                                    <p class="text-alphera font-20 m-0">NRE Report</p>
                                </div>
                                        ...
                                        <table class="table table-sm table-striped table-bordered m-0 text-center">
                                            <thead class="thead-alphera">
                                                <tr>
                                                    ...
                                                    <th colspan="6">NRE for Ex-Crew</th>
                                                    <th colspan="6">NRE for New Crew</th>
                                                </tr>
            ...
            <!-- <div class="row mb-5">
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <form action="javascript:void(0)" id="nre_report_form" enctype="application/x-www-form-urlencoded">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php $value = 1000 / 100;
                                            var_dump(number_format($value, 2)) ?>
                                            <select class="custom-select" id="nre_rank_filter" name="nre_rank_filter">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">Ex-crew NRE Data Count</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result0) : ?>
                                        <ul>
                                            <?php foreach ($nre_result0 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    <?php else : ?>
                                        <li>No NRE data for now</li>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result1) : ?>
                                        <ul>
                                            <?php foreach ($nre_result1 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result2) : ?>
                                        <ul>
                                            <?php foreach ($nre_result2 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result3) : ?>
                                        <ul>
                                            <?php foreach ($nre_result3 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result4) : ?>
                                        <ul>
                                            <?php foreach ($nre_result4 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if ($nre_result5) : ?>
                                        <ul>
                                            <?php foreach ($nre_result5 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-alphera font-20 m-0">New Hire NRE Data Count</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="page-title"> Current Year</h4>
                                    <?php if ($nh_nre_result0) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result0 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    <h4 class="page-title"> Last Year</h4>
                                    <?php if ($nh_nre_result1) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result1 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    <h4 class="page-title"> Last 2years</h4>
                                    <?php if ($nh_nre_result2) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result2 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    <h4 class="page-title"> Last 3years</h4>
                                    <?php if ($nh_nre_result3) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result3 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    <h4 class="page-title"> Last 4years</h4>
                                    <?php if ($nh_nre_result4) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result4 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                ...
                                <div class="col-md-6">
                                    <h4 class="page-title"> Last 5years</h4>
                                    <?php if ($nh_nre_result5) : ?>
                                        <ul>
                                            <?php foreach ($nh_nre_result5 as $key) : ?>
                                                <li><?= $key['position_name'] ?></li>
                                                <li><?= $key['description'] ?>: <?= $key['nre_count'] ?></li>
                                            <?php endforeach; ?>
                                        </ul>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/nre_report.js'); ?>"></script>