...
<div class="modal fade" id="promotion_mlc_contract_modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width: 65%;">
        <form action="javascript:void(0)" id="promotion_mlc_contract_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-alphera font-20 m-0" id="promotion_mlc_crew_name"></h4>
                    ...
                    <div class="row">
                        <div class="col-md-4" id="col_mlc_contract">
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="promotion_mlc_contract" name="promotion_edit_mlc_contract">
                        ...
                        <div class="col-md-12">
                            <div class="row" id="col_form_details">
                                <div class="col-md-4">
                                    ...
                                    <p class="text-dark font-15 mt-0 mb-2" id="promotion_form_number">-</p>
                                    <input type="hidden" id="promotion_mlc_form_number" name="promotion_mlc_form_number" class="form-control">
                                    <input type="hidden" id="promotion_crew_code" name="promotion_crew_code" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="text-muted m-0">Revision Number:</label>
                                    <p class="text-dark font-15 mt-0 mb-2" id="promotion_revision_number">-</p>
                                    <input type="hidden" id="promotion_mlc_revision_number" name="promotion_mlc_revision_number" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="text-muted m-0">Revision Date:</label>
                                    <p class="text-dark font-15 mt-0 mb-2" id="promotion_revision_date">-</p>
                                    <input type="hidden" id="promotion_mlc_revision_date" name="promotion_mlc_revision_date" class="form-control">
                                </div>
                            </div>
                                        ...
                                        <table class="table table-sm table-bordered mb-0">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="promotion_mlc_company_name" name="promotion_mlc_company_name" class="form-control" value="POS SM Co.,Ltd. / Myeong Su KIM" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="promotion_mlc_company_address" name="promotion_mlc_company_address" class="form-control" value="102, Joongang Daero, Jung-gu, Busan, Korea" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment"><input type="text" id="promotion_mlc_agent_name" name="promotion_mlc_agent_name" class="form-control" value="ALPHERA MARINE SERVICES INC.(formerly  POS-FIL SHIP MANAGEMENT CORPORATION)" readonly></td>
                                                </tr>

                                                <tr>
                                                    <td id="text-alignment">Address</td>
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="promotion_mlc_agent_address" name="promotion_mlc_agent_address" class="form-control" value="7F, Jemarson Place, 1626 Pilar Hidalgo Lim St., Malate, Manila, Philippines 1004" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <select class="custom-select" id="promotion_mlc_vessel_name" name="promotion_mlc_vessel_name" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <select class="custom-select" id="promotion_mlc_vessel_type" name="promotion_mlc_vessel_type" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_farer_name" name="promotion_mlc_farer_name" class="form-control" readonly>
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Duty</td>
                                                    <td id="text-alignment">
                                                        <!-- <input type="text" id="promotion_mlc_farer_duty" name="promotion_mlc_farer_duty" class="form-control"> -->
                                                        <select class="custom-select" id="promotion_mlc_farer_duty" name="promotion_mlc_farer_duty" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                    <td colspan="2"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_farer_passport" name="promotion_mlc_farer_passport" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Seaman's Book No.</td>
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_farer_book" name="promotion_mlc_farer_book" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">License No.</td>
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_farer_license" name="promotion_mlc_farer_license" class="form-control">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_farer_sex" name="promotion_mlc_farer_sex" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Nationality</td>
                                                    <td id="text-alignment">
                                                        <select class="custom-select" id="promotion_mlc_farer_nationality" name="promotion_mlc_farer_nationality" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Birth Date</td>
                                                    <td id="text-alignment">
                                                        <input type="date" id="promotion_mlc_farer_birthdate" name="promotion_mlc_farer_birthdate" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </thead>
                                            <!-- [END] -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="promotion_mlc_sign_place" name="promotion_mlc_sign_place" class="form-control">
                                                    </td>
                                                    <td colspan="2" id="text-alignment">1.2 Date</td>
                                                    <td colspan="3" id="text-alignment">
                                                        <input type="date" id="promotion_mlc_sign_date" name="promotion_mlc_sign_date" class="form-control">
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_bw" name="promotion_mlc_bw" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_ot" name="promotion_mlc_ot" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_pl" name="promotion_mlc_pl" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_sa" name="promotion_mlc_sa" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_rb" name="promotion_mlc_rb" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1" id="text-alignment">F. </td>
                                                    <td colspan="2" id="text-alignment">M.T: Monthly Total Salary (F = A ~ + E) </td>
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_mts" name="promotion_mlc_mts" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1" id="text-alignment">G. </td>
                                                    <td colspan="2" id="text-alignment">FKSU Special Membership Fee</td>
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_fksu" name="promotion_mlc_fksu" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="promotion_mlc_mt" name="promotion_mlc_mt" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2" id="text-alignment"><input type="date" class="form-control" id="promotion_mlc_employment_period_from" name="promotion_mlc_employment_period_from"></td>
                                                    <td colspan="1" id="text-alignment"><input type="date" class="form-control" id="promotion_mlc_employment_period_to" name="promotion_mlc_employment_period_to"></td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <thead class="text-left text-dark font-weight-medium bg-light font-letter-spacing">
                                                <tr>
                                                    <th colspan="7" id="esix_mp_header" style="display: none">6. Daily victualing expenses</th>
                                                    <th colspan="7" id="esix_k_header" style="display: none">6. Standard of Hours of Work and Hours of Rest</th>
                                                </tr>
                                            </thead>

                                            <tbody>
                                                <!-- KOREAN FLAG -->
                                                <tr id="esix_korean_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- PANAMA FLAG -->
                                                <tr id="esix_panama_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        Minimum 11.50 USD
                                                    </td>
                                                </tr>
                                                <!-- MARSHALL FLAG -->
                                                <tr id="esix_marshall_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        Minimum 11.50 USD
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody class="text-center">
                                                <tr class="text-left text-dark font-weight-medium bg-light">
                                                    <td colspan="7" id="eseven_mp_header" style="display: none">7. Standard of hours of work and hours of rest</td>
                                                    <td colspan="7" id="eseven_k_header" style="display: none">7. Health and social security protection benefits</td>
                                                </tr>

                                                <!-- KOREAN FLAG -->
                                                <tr id="eseven_korean_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- PANAMA FLAG -->
                                                <tr id="eseven_panama_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- MARSHALL FLAG -->
                                                <tr id="eseven_marshall_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        7.1 Working hours <br>
                                                        (1) Hours of Ordinary Work : 8 hrs in a day and 40 hrs in a week . / But, who onboard Korean flag vessel : 8 hrs in a day and 44 hrs in a week <br>
                                                        (2) Over time work : Fixed Over Time or Guranteed Over Time (103 hrs/Month) should be applied with the ship's CBA. <br>
                                            ...
                                            <tbody>
                                                <tr class="text-left text-dark font-weight-medium bg-light">
                                                    <td colspan="7" id="eeight_mp_header" style="display: none">8. Health and social security protection benefits</td>
                                                    <td colspan="7" id="eeight_k_header" style="display: none">8. Seafarer's entitlement to repatriation</td>
                                                </tr>

                                                <!-- KOREAN FLAG -->
                                                <tr id="eeight_korean_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                            ...
                                            <thead class="text-left text-dark font-weight-medium bg-light font-letter-spacing">
                                                <tr>
                                                    <th colspan="7" id="enine_k_header" style="display: none">9. Discipline</th>
                                                    <th colspan="7" id="enine_mp_header" style="display: none">9. Seafarer's entitlement to repatriation</th>
                                                </tr>
                                            </thead>

                                            <tbody>
                                                <!-- KOREAN FLAG -->
                                                <tr id="enine_korean_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- PANAMA FLAG -->
                                                <tr id="enine_panama_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- MARSHALL FLAG -->
                                                <tr id="enine_marshall_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        9.1 Shipowner shall promptly repatriate the seafarer who leaves a ship at the place of which is not the seafarer's country of residence or the place
                                                        at which the seafarer agreed to enter into the engagement as shipowner's expenses except on the misconduct or incompetence of seafarer.farer.
                                                        However, in case where shipowner paid the expense of repatriation according shipowner to the request of seafarer, does not have anyany
                                            ...
                                            <tbody>
                                                <!-- KOREAN FLAG -->
                                                <tr id="eetc_korean_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                ...
                                                <!-- PANAMA FLAG -->
                                                <tr id="eetc_panama_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        10.1 Signing of this Contract of Employment binds the seafarer to sign the appropriate article of agreement of the ship to which he may be appointed by the Company during his employment. <br> <br>
                                                ...
                                                <!-- MARSHALL FLAG -->
                                                <tr id="eetc_marshall_flag" style="display: none">
                                                    <td colspan="7" class="text-left font-weight-medium">
                                                        10.1 Signing of this Contract of Employment binds the seafarer to sign the appropriate article of agreement of the ship to which he may be appointed by the Company during his employment. <br> <br>
                                                        10.2 Any alterations or changes, in any part of this Contract shall be evaluated, verified, processed and approved by the Philippine Overseas Employment Administration (POEA). Upon approval, the same shall be deemed an integral part of the Standard Terms and conditionsgoverning the Employment of Filipino Seafarers On Board Ocean-Going Vessels. <br> <br>
                                                        10.3 Violations of the terms and conditions of this contract with its approved addendum shall he ground for disciplinary action against the erring party. <br> <br>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="promotion_mlc_name_of_seafared" name="promotion_mlc_name_of_seafared" readonly></td>
                                                </tr>

                                                <tr>
                                                    <td colspan="6" id="text-alignment">(On behalf of the shipowner(s) of the Vessel)</td>
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="promotion_mlc_shipowner_vessel" name="promotion_mlc_shipowner_vessel"></td>
                                                </tr>

                                                <tr>
                                                    <td colspan="6" id="text-alignment">Vice President Alphera Marine Services Inc.</td>
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="promotion_mlc_vp_alphera" name="promotion_mlc_vp_alphera"></td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                        </table>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnSavePromotion_mlc">Save Changes</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
$("#promotion_mlc_contract").on("change", function () {
    if (this.value == "1") {
        
        $("#promotion_form_number").html('SCRE-04B-02');
        $("#promotion_revision_number").html('03');
        $("#promotion_revision_date").html('2019-01-01');
        ...
        $("#esix_k_header").show();
        $("#eseven_k_header").show();
        $("#eeight_k_header").show();
        $("#enine_k_header").show();

        $("#esix_korean_flag").show();
        $("#eseven_korean_flag").show();
        $("#eeight_korean_flag").show();
        $("#enine_korean_flag").show();
        $("#eetc_korean_flag").show();

        $("#esix_mp_header").hide();
        $("#eseven_mp_header").hide();
        $("#eeight_mp_header").hide();
        $("#enine_mp_header").hide();

        $("#esix_panama_flag").hide();
        $("#eseven_panama_flag").hide();
        $("#eeight_panama_flag").hide();
        $("#enine_panama_flag").hide();
        $("#eetc_panama_flag").hide();

        $("#esix_marshall_flag").hide();
        $("#eseven_marshall_flag").hide();
        $("#eeight_marshall_flag").hide();
        $("#enine_marshall_flag").hide();
        $("#eetc_marshall_flag").hide();

    } else if (this.value == "2") {
        $("#promotion_form_number").html('SCRE-04B-01-02');
        $("#promotion_revision_number").html('04');
        $("#promotion_revision_date").html('2019-07-19');
        ...
        $("#esix_mp_header").show();
        $("#eseven_mp_header").show();
        $("#eeight_mp_header").show();
        $("#enine_mp_header").show();

        $("#esix_k_header").hide();
        $("#eseven_k_header").hide();
        $("#eeight_k_header").hide();
        $("#enine_k_header").hide();

        $("#esix_panama_flag").show();
        $("#eseven_panama_flag").show();
        $("#eeight_panama_flag").show();
        $("#enine_panama_flag").show();
        $("#eetc_panama_flag").show();
        ...
        $("#esix_korean_flag").hide();
        $("#eseven_korean_flag").hide();
        $("#eeight_korean_flag").hide();
        $("#enine_korean_flag").hide();
        $("#eetc_korean_flag").hide();
    } else if (this.value == "3") {
        $("#promotion_form_number").html('SCRE-04B-01-01');
        $("#promotion_revision_number").html('04');
        $("#promotion_revision_date").html('2019-07-19');
        ...
        $("#esix_marshall_flag").show();
        $("#eseven_marshall_flag").show();
        $("#eeight_marshall_flag").show();
        $("#enine_marshall_flag").show();
        $("#eetc_marshall_flag").show();
        ...
        $("#promotion_form_number").html('-');
        $("#promotion_revision_number").html('-');
        $("#promotion_revision_date").html('-');
        $("#col_form_details").show();
        $("#col_form_mlc").show();
    }
});
