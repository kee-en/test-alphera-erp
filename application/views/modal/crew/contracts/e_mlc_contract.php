...
<div class="modal fade" id="edit_mlc_contract_modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width: 65%;">
        <form action="javascript:void(0)" id="edit_mlc_contract_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-alphera font-20 m-0" id="edit_mlc_crew_name"></h4>
                    ...
                    <div class="row">
                        <div class="col-md-4" id="col_mlc_contract">
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="c_edit_mlc_contract" name="c_edit_mlc_contract">
                        ...
                        <div class="col-md-12">
                            <div class="row" id="col_form_details">
                                <div class="col-md-4">
                                    ...
                                    <p class="text-dark font-15 mt-0 mb-2" id="form_number">-</p>
                                    <input type="hidden" id="edit_mlc_form_number" name="edit_mlc_form_number" class="form-control">
                                    <input type="hidden" id="crew_code" name="crew_code" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="text-muted m-0">Revision Number:</label>
                                    <p class="text-dark font-15 mt-0 mb-2" id="revision_number">-</p>
                                    <input type="hidden" id="edit_mlc_revision_number" name="edit_mlc_revision_number" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="text-muted m-0">Revision Date:</label>
                                    <p class="text-dark font-15 mt-0 mb-2" id="revision_date">-</p>
                                    <input type="hidden" id="edit_mlc_revision_date" name="edit_mlc_revision_date" class="form-control">
                                </div>
                            </div>
                                        ...
                                        <table class="table table-sm table-bordered mb-0">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="edit_mlc_company_name" name="edit_mlc_company_name" class="form-control" value="POS SM Co.,Ltd. / Myeong Su KIM" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="edit_mlc_company_address" name="edit_mlc_company_address" class="form-control" value="102, Joongang Daero, Jung-gu, Busan, Korea" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment"><input type="text" id="edit_mlc_agent_name" name="edit_mlc_agent_name" class="form-control" value="ALPHERA MARINE SERVICES INC.(formerly  POS-FIL SHIP MANAGEMENT CORPORATION)" readonly></td>
                                                </tr>

                                                <tr>
                                                    <td id="text-alignment">Address</td>
                                                    <td colspan="5" id="text-alignment">
                                                        <input type="text" id="edit_mlc_agent_address" name="edit_mlc_agent_address" class="form-control" value="7F, Jemarson Place, 1626 Pilar Hidalgo Lim St., Malate, Manila, Philippines 1004" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <select class="custom-select" id="edit_mlc_vessel_name" name="edit_mlc_vessel_name" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" id="text-alignment">
                                                        <select class="custom-select" id="edit_mlc_vessel_type" name="edit_mlc_vessel_type" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_farer_name" name="edit_mlc_farer_name" class="form-control" readonly>
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Duty</td>
                                                    <td id="text-alignment">
                                                        <!-- <input type="text" id="edit_mlc_farer_duty" name="edit_mlc_farer_duty" class="form-control"> -->
                                                        <select class="custom-select" id="edit_mlc_farer_duty" name="edit_mlc_farer_duty" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                    <td colspan="2"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_farer_passport" name="edit_mlc_farer_passport" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Seaman's Book No.</td>
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_farer_book" name="edit_mlc_farer_book" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">License No.</td>
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_farer_license" name="edit_mlc_farer_license" class="form-control">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_farer_sex" name="edit_mlc_farer_sex" class="form-control">
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Nationality</td>
                                                    <td id="text-alignment">
                                                        <select class="custom-select" id="edit_mlc_farer_nationality" name="edit_mlc_farer_nationality" disabled>
                                                            <option value="">Choose option</option>
                                                        </select>
                                                    </td>
                                                    <td colspan="1" id="text-alignment">Birth Date</td>
                                                    <td id="text-alignment">
                                                        <input type="date" id="edit_mlc_farer_birthdate" name="edit_mlc_farer_birthdate" class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </thead>
                                            <!-- [END] -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="text-alignment">
                                                        <input type="text" id="edit_mlc_sign_place" name="edit_mlc_sign_place" class="form-control">
                                                    </td>
                                                    <td colspan="2" id="text-alignment">1.2 Date</td>
                                                    <td colspan="3" id="text-alignment">
                                                        <input type="date" id="edit_mlc_sign_date" name="edit_mlc_sign_date" class="form-control">
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_bw" name="edit_mlc_bw" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_ot" name="edit_mlc_ot" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_pl" name="edit_mlc_pl" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_sa" name="edit_mlc_sa" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_rb" name="edit_mlc_rb" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1" id="text-alignment">F. </td>
                                                    <td colspan="2" id="text-alignment">M.T: Monthly Total Salary (F = A ~ + E) </td>
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_mts" name="edit_mlc_mts" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1" id="text-alignment">G. </td>
                                                    <td colspan="2" id="text-alignment">FKSU Special Membership Fee</td>
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_fksu" name="edit_mlc_fksu" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="text-alignment"><input type="text" id="edit_mlc_mt" name="edit_mlc_mt" class="form-control"></td>
                                                    <td colspan="4" id="text-alignment">US$/Month</td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2" id="text-alignment"><input type="date" class="form-control" id="edit_mlc_employment_period_from" name="edit_mlc_employment_period_from"></td>
                                                    <td colspan="1" id="text-alignment"><input type="date" class="form-control" id="edit_mlc_employment_period_to" name="edit_mlc_employment_period_to"></td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="edit_mlc_name_of_seafared" name="edit_mlc_name_of_seafared" readonly></td>
                                                </tr>

                                                <tr>
                                                    <td colspan="6" id="text-alignment">(On behalf of the shipowner(s) of the Vessel)</td>
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="edit_mlc_shipowner_vessel" name="edit_mlc_shipowner_vessel"></td>
                                                </tr>

                                                <tr>
                                                    <td colspan="6" id="text-alignment">Vice President Alphera Marine Services Inc.</td>
                                                    <td colspan="1" id="text-alignment"><input type="text" class="form-control" id="edit_mlc_vp_alphera" name="edit_mlc_vp_alphera"></td>
                                                </tr>
                                            </tbody>
                                            <!-- [END] -->
                                        </table>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnSaveChanges_mlc">Save Changes</button>
                </div>
            </div>
        </form>
    </div>
