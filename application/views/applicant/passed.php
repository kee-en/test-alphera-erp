...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Passed Applicants</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Passed Applicants</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">List of Passed Applicants</p>
                                    <span class="text-muted font-18">These are the applicants that recently <span class="text-underline">passed</span> their application by the assessor(s).</span>
                                </div>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url('print-passed-applicant-csv') ?>">CSV</a>
                                                <a class="dropdown-item" href="<?= base_url('print-passed-applicant-xl') ?>">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url('print-passed-applicants') ?>" target="_blank">PDF</a>

                                                <!-- <a class="dropdown-item" href="<?= base_url('print-passed-applicant-pdf') ?>">PDF</a> -->
                                            </div>
                                        </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mt-1 mb-0 font-17"><?= strtoupper($key['full_name']) ?></h5>
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            <h4 class="m-0 font-15"><?= (!$key['vessel_code'] ? '<span class="text-danger">-</span>' : $key['vessel_code']) ?></h4>
                                                    ...
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            ...
                                                            <p class="mb-0 text-muted text-truncate font-15 font-15">BMI</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            ...
                                                            <?php endif; ?>
                                                            <h4 class="m-0 font-15 <?= $color; ?>" title="<?= (!$key['nat_result'] ? 'NO RESULT AVAILABLE' : $key['nat_result'] . '%') ?>"><?= (!$key['nat_result'] ? '<span class="text-danger">N/A</span>' : $key['nat_result'] . '%') ?></h4>
                                                    ...
                                                    <div class="col">
                                                        <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="moveCMPlan('<?= $key['applicant_code'] ?>')">Add to CM Plan (as Crew)</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/passed.js') ?>"></script>