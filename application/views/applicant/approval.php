                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Principal Approval</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Principal Approval</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">List of Principal Approval</p>
                                    <span class="text-muted font-18">These are the applicants which currently wait for <span class="text-underline">approval</span> by the principal.</span>
                                </div>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url('print-approval-applicant-csv') ?>">CSV</a>
                                                <a class="dropdown-item" href="<?= base_url('print-approval-applicant-xl') ?>">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url('print-principal-approval-applicants') ?>" target="_blank">PDF</a>

                                                <!-- <a class="dropdown-item" href="<?= base_url('print-approval-applicant-pdf') ?>">PDF</a> -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-2" id="div_applicant">
                                            <li class="list-group-item">
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            <h4 class="m-0 font-15"><?= (!$key['approved_position'] ? '<span class="text-danger">-</span>' : $key['approved_position']) ?></h4>
                                                            <p class="mb-0 text-muted text-truncate font-15">Approved Position</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            <h4 class="m-0 font-15"><?= (!$key['vsl_code'] ? '<span class="text-danger">-</span>' : $key['vsl_code']) ?></h4>
                                                            <p class="mb-0 text-muted text-truncate font-15">Tentative Vessel</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" onclick="showNatResult('<?= $key['applicant_code'] ?>', '<?= $key['full_name'] ?>')" data-target="#nat_result_modal">&nbsp;<?= (($this->global->natResult($key['applicant_code']) === true) ? '<i id="eval_form_icon" class="mdi mdi-checkbox-marked-circle font-15 text-success"></i>' : 'Add') ?> NAT Exam Result</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" onclick="showInterviewSheet('<?= $key['applicant_code'] ?>')" data-target="#interview_sheet_modal">&nbsp; <?= (($this->global->interviewSheetFinalScore($key['applicant_code']) === true) ? '<i id="eval_form_icon" class="mdi mdi-checkbox-marked-circle font-15 text-success"></i>' : 'Edit') ?> Interview Sheet</a>
                                                                ...
                                                                <?php if ($this->global->natResult($key['applicant_code']) === true && $this->global->interviewSheetFinalScore($key['applicant_code']) === true) : ?>
                                                                    <div role="separator" class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" onclick="updateApplicantStatus('6', '<?= $key['applicant_code'] ?>')">&nbsp; Add to Passed</a>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </div>
