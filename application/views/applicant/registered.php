...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Registered Applicants</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Registered Applicants</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">List of Registered Applicants</p>
                                    <span class="text-muted font-18">These are the applicants that recently <span class="text-underline">registered</span> to the website.</span>
                                </div>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url('print-registered-applicant-csv') ?>">CSV</a>
                                                <a class="dropdown-item" href="<?= base_url('print-registered-applicant-xl') ?>">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url('print-registered-applicants') ?>" target="_blank">PDF</a>
                                                <!-- <a class="dropdown-item" href="<?= base_url('print-registered-applicant-pdf') ?>">PDF</a> -->
                                            </div>
                                        </div>
                                ...
                                <?php if (!empty($applicants)) : ?>
                                    <?php foreach ($applicants as $key) : ?>
                                        <div class="col-md-4 mb-2" id="div_applicant">
                                            ...
                                            <?php if ($key['f_assessor_name']) : ?>
                                                <?php $bg_color = '#ffffff'; ?>
                                            <?php else : ?>
                                                <?php $bg_color = '#fffdf1'; ?>
                                            <?php endif; ?>

                                            <li class="list-group-item" style="background: <?= $bg_color ?>">
                                                <div class="media">
                                                    <img class="align-self-start mr-3" id="applicant_img" src="<?= $this->applicant_registered->getApplicantPhoto("{$this->global->ecdc('ec',$key['applicant_code'])}"); ?>" alt="" width="50" onerror="applicantImageError(this);">
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            <h4 class="m-0 font-15"><?= (!$key['position_two'] ? '<span class="text-danger">-</span>' : $key['position_two']) ?></h4>
                                                    ...
                                                    <div class="col-3" id="applicant_data">
                                                        <div class="m-0">
                                                            <h4 class="m-0 font-15 text-truncate" title="<?= (!$key['f_assessor_name'] ? 'NOT AVAILABLE' : $key['f_assessor_name']) ?>"><?= (!$key['f_assessor_name'] ? '<span class="text-danger">N/A</span>' : $key['f_assessor_name']) ?></h4>
                                                            <p class="mb-0 text-muted text-truncate font-15">Assessed By</p>
                                                            <input type="hidden" id="assessor_id" name="assessor_id" value="<?= $key['assessed_by'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col">
                                                        <?php if (!$key['crew_code']) : ?>
                                                            <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <?php if (!$key['f_assessor_name']) : ?>
                                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="updateApplicantStatus('1', '<?= $key['applicant_code'] ?>','<?= $this->global->ecdc('dc', $this->session->userdata('user_code')) ?>')">Proceed to NAT Exam</a>
                                                                    <?php endif; ?>
                                                                    ...
                                                                    <a class="dropdown-item" href="<?= base_url("print-shipboard-application/{$key['applicant_code']}") ?>" target="_blank">Print Shipboard Application</a>
                                                                    <div role="separator" class="dropdown-divider"></div>
                                                                    <a class="dropdown-item text-pink" href="javascript:void(0)" onclick="updateApplicantStatus('7', '<?= $key['applicant_code'] ?>')">Add to Reserved Applicants</a>
                                                                    <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="applicantNotQualifiedModal('<?= $key['applicant_code'] ?>')">Add to Not Qualified</a>
                                                                </div>
                                                            </div>
                                                        <?php else : ?>
                                                            <button type="button" class="btn btn-secondary btn-block" disabled style="cursor: not-allowed;"><i class="mdi mdi-dots-horizontal"></i></button>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </li>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/registered.js') ?>"></script>