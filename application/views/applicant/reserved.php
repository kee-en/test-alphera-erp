...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"> Reserved Applicants</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Reserved Applicants</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-header">
                            <div class="row justify-content-between">
                                <div class="col-md-8" id="lbl-title">
                                    <p class="text-alphera font-20 m-0">List of Reserved Applicants</p>
                                    <span class="text-muted font-18">These are the applicants which currently <span class="text-underline">reserved</span> by the assessor(s).</span>
                                </div>
                                    ...
                                    <div class="btn-group btn-grp-collection" role="group" aria-label="">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url('print-reserved-applicant-csv') ?>">CSV</a>
                                                <a class="dropdown-item" href="<?= base_url('print-reserved-applicant-xl') ?>">EXCEL</a>
                                                <a class="dropdown-item" href="<?= base_url('print-reserved-applicants') ?>" target="_blank">PDF</a>

                                                <!-- <a class="dropdown-item" href="<?= base_url('print-reserved-applicant-pdf') ?>">PDF</a> -->
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="btn-group dropdown btn-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item text-pink" href="javascript:void(0)" onclick="revertApplicantStatus('<?= $key['applicant_code'] ?>')">Revert Application</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript" src="<?= base_url('assets/javascript/reserved.js') ?>"></script>